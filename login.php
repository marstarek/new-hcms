...
if ($row = mysqli_fetch_assoc($result)) {
    ...
    $checkQuery = "select CASE WHEN HOUR(timediff(sysdate(),timein)) >= '24' THEN 'Passed' ELSE 'NotPassed' END AS checkResult FROM trans WHERE code = $ffl order by id desc limit 1;";
