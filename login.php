    ...
    <main>
        <div class="container p-5 ">
            <div class="text-center"
                style="border-radius: .6875rem;margin: 0 auto;width: 40%;padding: 1.875rem;box-shadow: rgba(0, 0, 0, 0.2) 0rem 1.125rem 3.125rem -0.625rem;">
                ...
                <form action="login.php" method="Post" class="text-center">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingInput" type="Username" name="Username"
                    ...
                    <div class=" pt-4 d-flex justify-content-center  align-items-center flex-column">
                        <button class="btn btn-primary py-2 px-3" type="submit" name="submit"
